...
type V2 struct {
	...
	EvolutionVariable       string `json:"evolution-variable"`
		...
		VersionDetails []struct {
			EncounterDetails []struct {
				...
				PokemonDetails  *struct {
					AlwaysShiny   bool     `json:"always_shiny"`
					IsAlpha       bool     `json:"is_alpha"`
					MinPerfectIvs struct{} `json:"min_perfect_ivs"`
					NeverShiny    bool     `json:"never_shiny"`
				} `json:"pokemon_details"`
...
type PokemonForm struct {
	...
	TriggerConditions []struct {
		BaseForm *NamedApiResource `json:"base_form,omitempty"`
	...
	Chain           struct {
		...
		EvolvesTo        []struct {
			EvolutionDetails []struct {
				AllowedNatures      []NamedApiResource `json:"allowed_natures"`
				ConditionExpression *struct {
					Expression       string             `json:"expression"`
					PercentageChance *json.Number       `json:"percentage_chance"`
					Variables        []NamedApiResource `json:"variables"`
				} `json:"condition_expression"`
				EvolvedPokemonForm    *NamedApiResource `json:"evolved_pokemon_form"`
				...
				NearSpecialRock       bool              `json:"near_special_rock"`
				...
				RequiredPokemonForm   *NamedApiResource `json:"required_pokemon_form"`
			...
			EvolvesTo []struct {
				EvolutionDetails []struct {
					AllowedNatures        struct{}          `json:"allowed_natures"`
					ConditionExpression   struct{}          `json:"condition_expression"`
					EvolvedPokemonForm    *NamedApiResource `json:"evolved_pokemon_form"`
					Gender                *int64            `json:"gender"`
					HeldItem              *NamedApiResource `json:"held_item"`
					IsDefault             bool              `json:"is_default"`
...
type Item struct {
	...
	Names    []Name                 `json:"names"`
	Prices   []struct {
		Currency      NamedApiResource `json:"currency"`
